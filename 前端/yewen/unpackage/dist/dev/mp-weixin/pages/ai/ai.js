...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o((...args) => $options.showMenu && $options.showMenu(...args), "5b"),
    d: $data.hasMoreHistory
  }, $data.hasMoreHistory ? {} : {}, {
    e: $data.messages.length === 0
  }, $data.messages.length === 0 ? {
    f: common_assets._imports_0,
    g: common_vendor.o(($event) => $options.quickAsk("识别病虫害"), "fb"),
    h: common_vendor.o(($event) => $options.quickAsk("防治方法"), "41"),
    i: common_vendor.o(($event) => $options.quickAsk("农药使用"), "fd"),
    j: common_vendor.o(($event) => $options.quickAsk("种植技术"), "26")
  } : {}, {
    k: common_vendor.f($data.messages, (msg, idx, i0) => {
      return common_vendor.e({
    ...
    n: $data.scrollToView,
    o: common_vendor.o((...args) => $options.loadMoreHistory && $options.loadMoreHistory(...args), "85"),
    p: $data.quickReplies.length > 0
  }, $data.quickReplies.length > 0 ? {
    q: common_vendor.f($data.quickReplies, (reply, k0, i0) => {
      return {
    ...
    r: common_vendor.o((...args) => $options.showImagePicker && $options.showImagePicker(...args), "94"),
    s: common_vendor.o((...args) => $options.showVoiceInput && $options.showVoiceInput(...args), "91"),
    t: common_vendor.o((...args) => $options.sendMessage && $options.sendMessage(...args), "d7"),
    v: common_vendor.o((...args) => $options.onInputFocus && $options.onInputFocus(...args), "41"),
    w: common_vendor.o((...args) => $options.onInputBlur && $options.onInputBlur(...args), "49"),
    x: $data.inputText,
    y: common_vendor.o(($event) => $data.inputText = $event.detail.value, "af"),
    z: common_vendor.o((...args) => $options.sendMessage && $options.sendMessage(...args), "44"),
    A: $data.showMenuModal
  }, $data.showMenuModal ? {
    B: common_vendor.o((...args) => $options.clearHistory && $options.clearHistory(...args), "ca"),
    C: common_vendor.o((...args) => $options.shareChat && $options.shareChat(...args), "6a"),
    D: common_vendor.o((...args) => $options.goToFeedback && $options.goToFeedback(...args), "95"),
    E: common_vendor.o(() => {
    }, "44"),
    F: common_vendor.o(($event) => $data.showMenuModal = false, "44")
  } : {});
}
