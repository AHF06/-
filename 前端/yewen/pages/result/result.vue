...
.result-header {
  ...
  .header-right { width: 80px; display: flex; gap: 16px; justify-content: flex-end; }
  .header-right .voice-icon, .header-right .share-icon { font-size: 22px; }
}
...
.voice-tip {
  ...
  .voice-tip-icon { font-size: 18px; }
  .voice-tip-text { font-size: 13px; color: #2c5e2a; }
}
...
.voice-status {
  ...
  .voice-status-text { color: white; font-size: 14px; }
  .voice-stop { padding: 4px 8px; background: rgba(255,255,255,0.2); border-radius: 30px; }
}
